#UNITS: um,s,/um^3
#METHOD: solve discrete cluster dynamics equation and compare with results in T.Jourdan Efficient simulation of kinetics of radiation induced defects (figure 5)
#NOTE: no grain boundary sink is considered
...
# define defect variables, set variables and boundadry condition as 0
  [./defects]
    scaling = 1.0e-2  #important factor to converge
    boundary_value = 0.0
    bc_type = neumann
  [../]
[]
