...
#set the largest size for vacancy clusters and interstitial clusters. Also defined in blocks to be clearer.
  ...
  number_v = 100    #number of vacancy variables i.e. total_groups
  number_single_v = 52  #max size with group size 1
  max_mobile_v = 4
  mobile_v_size = '1 2 3 4'

  number_i = 100      #number of interstitial variables, set to 0
...
[AuxVariables]
  active = 'void_swelling source1 source50'
  [./void_swelling]
  [../]
  [./SIA_density]
  [../]
...
[AuxKernels]
  [./S1]
    type = FunctionAux
    variable = source1
    function = func_defect_v1
    execute_on = initial
  [../]
  [./S2]
    type = FunctionAux
    variable = source50
    function = func_defect_v50
    execute_on = initial
  [../]
[]
